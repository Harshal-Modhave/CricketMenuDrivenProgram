...
void accept_details(struct player_record player[], int no_of_player);
void print_details(struct player_record player[], int no_of_player);
void Batsmen_country(struct player_record player[], int no_of_player);
void Bolwer_country(struct player_record player[], int no_of_player);
...
void Max_wicket(struct player_record player[], int no_of_player);
...
int main()
{
    ...
    accept_details(player, no_of_players);
    ...
    do
    {
        ...
        {
        case 1:
            print_details(player, no_of_players);
            break;

        case 2:
            Batsmen_country(player, no_of_players);
            break;

        case 3:
            Bolwer_country(player, no_of_players);
            break;
        ...
        case 7:
            Max_wicket(player, no_of_players);
            break;
